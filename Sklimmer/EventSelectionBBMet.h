...
private:
  EventSelectionBBMet()                                             = delete ; //need a store to work
  EventSelectionBBMet(const EventSelectionBBMet& that)              = delete;
  EventSelectionBBMet& operator = (const EventSelectionBBMet& that) = delete;
